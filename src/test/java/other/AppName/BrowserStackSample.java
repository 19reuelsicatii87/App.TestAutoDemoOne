...
public class BrowserStackSample {
  ...
  public static void main(String[] args)
    ...
    browserstackOptions.put("userName", "licenses_l5aIeD");
    browserstackOptions.put("accessKey", "QYTmGxxvTJ9bxLAERqYU");
    ...
    caps.setCapability("app", "bs://0bbe7bfd19a3d75171be8773848a436ce1de0ade");
